...
<template>
  ...
  <AgentChatWindow
    ...
    default-instructions="Voce é um assistente virtual especializado em ajudar o usuario a solicitar descontos em produtos automotivos. Utilize as ferramentas disponiveis para solicitar o desconto."
  >
    <template #icon>
